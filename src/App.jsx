...
export default function App() {
  ...
  function applyPromo() {
    ...
    if (!code) return;
    const catalog = {
      OUTDOORVOICES10: { type: 'percent', value: 10 },
    ...
    <>
      ...
      <header className="site-header">
        <div className="site-header__row">
          ...
          <a href="#" className="site-logo" aria-label="CALPAK">
            <img src={brand.logoSrc} alt="CALPAK" />
          </a>
      ...
      <div className={`mobile-menu${menuOpen ? ' is-open' : ''}`}>
        <div className="mobile-menu__body">
          ...
          <nav className="mobile-menu__nav">
            <a href="#" className="mobile-menu__nav-main">shop all</a>
            <a href="#" className="mobile-menu__nav-main">skin</a>
            <a href="#" className="mobile-menu__nav-main">about</a>
          </nav>
        </div>
      </div>
